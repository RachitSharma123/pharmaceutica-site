    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <span className="inline-block mb-4 text-sm tracking-[0.2em] text-[#7b4397] font-medium uppercase">
              {subHeroConfig.tag}
            </span>
            ...
            {subHeroConfig.linkText && (
              <a
                ...
                className="inline-flex items-center gap-2 text-[#7b4397] font-medium tracking-wide hover:gap-4 transition-all duration-300"
              >
                {subHeroConfig.linkText}
          ...
          <div className="relative h-[500px] md:h-[600px] lg:h-[700px]" style={{ perspective: '1200px' }}>
            ...
            {/* Decorative line */}
            <div
              className="absolute top-[10%] left-[-5%] w-32 h-32 border border-[#7b4397]/20"
              style={{
            ...
            {/* Floating accent dot */}
            <div
              className="absolute bottom-[15%] right-[-3%] w-4 h-4 rounded-full bg-[#7b4397]/30"
              style={{
                opacity: isVisible ? 1 : 0,
          ...
          >
            {subHeroConfig.stats.map((stat, index) => (
              <div key={index} className={`p-6 ${index < subHeroConfig.stats.length - 1 ? 'border-r border-gray-200' : ''}`}>
                <span className="block font-serif text-4xl md:text-5xl text-[#7b4397] mb-2">
