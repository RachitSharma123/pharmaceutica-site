            ...
            <div className="space-y-6 mb-12">
              {contactConfig.location && (
                <div className="flex items-center gap-4">
                  <MapPin size={20} strokeWidth={1.5} className="text-[#7b4397]" />
                  <div>
              ...
              {contactConfig.email && (
                <div className="flex items-center gap-4">
                  <Mail size={20} strokeWidth={1.5} className="text-[#7b4397]" />
                  <div>
                    <span className="block text-xs uppercase tracking-wider opacity-60 mb-1">{contactConfig.emailLabel}</span>
                    <a href={`mailto:${contactConfig.email}`} className="font-light hover:text-[#7b4397] transition-colors">
                      {contactConfig.email}
                    </a>
                  </div>
                </div>
              ...
              {contactConfig.phone && (
                <div className="flex items-center gap-4">
                  <Phone size={20} strokeWidth={1.5} className="text-[#7b4397]" />
                  <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div>
                <input
                  ...
                  required
                  className="w-full bg-transparent border-b border-white/50 text-white placeholder-white/50 py-4 focus:outline-none focus:border-[#7b4397] transition-colors font-light text-lg"
                />
              </div>
              ...
              <div>
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full bg-transparent border-b border-white/50 text-white placeholder-white/50 py-4 focus:outline-none focus:border-[#7b4397] transition-colors font-light text-lg resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-5 bg-[#7b4397] text-white font-light tracking-widest text-sm btn-hover disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
