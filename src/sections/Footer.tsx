              ...
              {footerConfig.socialLinks.map((social) => {
                ...
                return (
                  <a
                    key={social.label}
                    href={social.href}
                    className="text-[#696969] hover:text-[#7b4397] transition-all duration-300 hover:scale-90"
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 text-sm focus:outline-none focus:border-[#7b4397] transition-colors"
                  />
                </div>
                <button
                  type="submit"
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-[#7b4397] text-white text-sm font-light tracking-wider btn-hover"
                >
                  {isSubscribed ? (
